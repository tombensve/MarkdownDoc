...
@CompileStatic
@TypeChecked
class PDFITextGenerator /*implements Generator*/ {
...
//                    writeImage((Image)docItem, pdfParagraph, context, paragraph.parseFile)
//                    break
//
//                case DocFormat.Link:
...
//                            @NotNull final PDFGeneratorContext context, @NotNull final File originalFile) {
//
//        final PDFImage pdfImage = PDFImage.getInstance(new URL(context.fileResource.resolveUrl(image.url, originalFile)))
//
//        if (pdfImage != null) {
