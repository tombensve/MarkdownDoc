 ...
 */
class PDFGeneratorDevTest4 extends GroovyTestCase {

    public void testParser() throws Exception {

        // Handle both IntelliJ and Maven who runs from different roots! (I see this as a bug in IntelliJ)
        File testFile = new File("src/test/resources/GNU_Affero_General_Public_License-v3.md") // Maven
        File pdfFile = new File("src/test/resources/GNU_Affero_General_Public_License-v3.pdf")
        if (!testFile.exists()) {
            testFile = new File("Library/src/test/resources/GNU_Affero_General_Public_License-v3.md") // IntelliJ
            pdfFile = new File("Library/src/test/resources/GNU_Affero_General_Public_License-v3.pdf")
        }
