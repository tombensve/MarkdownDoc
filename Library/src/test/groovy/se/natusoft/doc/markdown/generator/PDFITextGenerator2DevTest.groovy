 ...
 */
@CompileStatic
class PDFITextGenerator2DevTest extends GroovyTestCase {
    ...
    public void testParser() throws Exception {
        ...
        File pdfFile = new File("src/test/resources/blogEntry.pdf")
        if (!testFile.exists()) {
            testFile = new File("Library/src/test/resources/blogEntry.md") // IntelliJ
            pdfFile = new File("Library/src/test/resources/blogEntry.pdf")
        }
