...
import se.natusoft.doc.markdowndoc.editor.gui.EditableSelectorLeftPopup
...
@CompileStatic
@TypeChecked
class SelectEditableLeftFunction implements EditorFunction, Configurable {
    //
    // Private Members
    //
    ...
    private EditableSelectorLeftPopup popup = null
    ...
    public SelectEditableLeftFunction() {
    ...
    void perform() throws FunctionException {
        this.popup = new EditableSelectorLeftPopup(editor: this.editor, closer: { close() } )
